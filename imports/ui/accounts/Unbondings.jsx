                    ...
                    this.setState({
                        ...
                        unbondings: result.map((u, i) => {
                            return <Row key={i} className="delegation-info">
                                <Col md={5} className="text-nowrap overflow-auto"><Account address={u.validator_addr} /></Col>
                                <Col md={7}>
                                    <Row>
                                        <Col md={6}>
                                            {numbro(parseFloat(u.balance)).format("0,0.00")} {Meteor.settings.public.stakingDenom}
                                        </Col>
                                        <Col md={6}>
                                            {moment.utc(u.min_time).fromNow()}
                                        </Col>
                                    </Row>
                                </Col>
                            </Row>
