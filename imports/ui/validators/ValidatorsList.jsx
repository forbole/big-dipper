                ...
                <Table striped className="validator-list">
                    <thead>
                        <tr>
                            ...
                            {(!this.props.jailed)?<th className="proposer-priority text-right" onClick={(e) => this.toggleDir(3,e)}><i className="material-icons">swap_vertical_circle</i> <span className="d-none d-sm-inline">Proposer Priority</span> {(this.state.proposerDir==1)?<i className="material-icons">arrow_drop_up</i>:<i className="material-icons">arrow_drop_down</i>}</th>:''}
