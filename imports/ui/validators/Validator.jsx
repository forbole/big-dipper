            ...
            if (this.props.validatorExist){
                ...
                return <Row className="validator-details">
                    ...
                    <Col md={4}>
                        ...
                        <MagpiePanel isLogIn={this.props.validator && this.props.validator.delegator_address && this.state.user && this.props.validator.delegator_address === this.state.user}
