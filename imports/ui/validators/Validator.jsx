...
import Block from '/imports/ui/components/Blocks.jsx';
import { Badge, Container, Row, Col, Card, CardImg, CardText, CardBody,
...
export default class Validator extends Component{
    constructor(props){
        ...
        this.state = {
            identity: "",
            avatar: "https://ui-avatars.com/api/?rounded=true&size=300&name=",
            records: ""
        }
    }
        ...
        if (this.props.validator != prevState.validator){
            ...
            if ((this.props.validator.description) && (this.props.validator.description != prevState.validator.description)){
                ...
                if (this.state.identity != this.props.validator.description.identity){
                    ...
                    if (this.props.validator.description.identity == ""){
                        this.setState({
                            avatar: "https://ui-avatars.com/api/?rounded=true&size=300&name="+this.props.validator.description.moniker
                        })
                    }
                    else{
                        fetch("https://keybase.io/_/api/1.0/user/lookup.json?key_suffix="+this.props.validator.description.identity+"&fields=pictures")
            ...
            return <Row className="validator-details">
                <Col md={4}>
                    <Card body className="text-center">
                        <div className="validator-avatar"><img src={this.state.avatar} className="img-fluid rounded-circle"/></div>
