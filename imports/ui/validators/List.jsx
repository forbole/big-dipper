...
const ValidatorRow = (props) => {
    ...
    return <Card body>
        <Row className="validator-info">
            ...
            {(!props.jailed)?<Col className="comission data" xs={{size:5, offset:2}} md={{size:1,offset:0}} lg={2}><i className="material-icons d-sm-none">call_split</i> <span>{numeral(props.validator.commission.rate).format('0.00%')}</span></Col>:''}
