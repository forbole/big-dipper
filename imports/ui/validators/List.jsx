...
const ValidatorRow = (props) => {
    ...
    return <Card body>
        <Row className="validator-info">
            ...
            {(!props.inactive)?<Col className="commission data" xs={{size:4}} md={{size:1,offset:0}} lg={2}><i className="material-icons d-sm-none">call_split</i> <span>{numbro(props.validator.commission.CommissionRates.rate).format('0.00%')}</span></Col>:''}
