...
const ValidatorRow = (props) => {
    ...
    return <Card body>
        <SentryBoundary><Row className="validator-info">
            ...
            <Col className="voting-power data" xs={{size:8, offset:2}} md={{size:3, offset:0}} lg={2}><i className="material-icons d-md-none">power</i>  <span>{props.validator.voting_power*Meteor.settings.public.onChainPowerReduction?numbro(Math.floor(props.validator.voting_power*Meteor.settings.public.onChainPowerReduction/Meteor.settings.public.powerReduction)).format('0,0'):0} ({props.validator.voting_power?numbro(props.validator.voting_power*Meteor.settings.public.onChainPowerReduction/Meteor.settings.public.powerReduction/props.totalPower).format('0.00%'):"0.00%"})</span></Col>
