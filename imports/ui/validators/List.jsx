...
const ValidatorRow = (props) => {
    ...
    return <Card body>
        <Row className="validator-info">
            ...
            {(!props.jailed)?<Col className="uptime data" xs={{size:4,order:"last"}} md={1} lg={2}><Progress animated value={props.validator.uptime}>{props.validator.uptime?props.validator.uptime.toFixed(2):0}%</Progress></Col>:''}
