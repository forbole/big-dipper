...
const ValidatorRow = (props) => {
    ...
    return <tr>
        ...
        <td><Link to={"/validator/"+props.validator.address}><Avatar moniker={moniker} identity={props.validator.description.identity} list={true} key={props.key}/>{moniker}</Link> {props.validator.description.identity? <KeybaseCheck identity={props.validator.description.identity} />:''}</td>
