    ...
    render() {
        return(
            <Row className="header text-nowrap d-none d-sm-flex">
                ...
                <Col xs={2}><i className="fas fa-desktop"></i> <span className="d-none d-md-inline"><T>validators.website</T></span></Col>
                ...
                <Col xs={1}><span className="d-none d-md-inline"><T>signers.lastSigned</T></span></Col>
