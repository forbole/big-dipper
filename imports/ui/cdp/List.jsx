...
const CDPRow = (props) => {
    return <tr>
        ...
        <td className="collateral-deposited">{props.cdpList.cdp.collateral ? <div>{new Coin(props.cdpList.cdp.collateral.amount, props.cdpList.cdp.collateral.denom).toString(4)}</div> : '0 BNB'}</td>
