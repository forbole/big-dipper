...
const CDPRow = (props) => {
    ...
    return <tr>
        <th className="d-none d-sm-table-cell counter ">{props.cdpList.cdp.id}</th>
            <td className="title"><Link to={"/account/"+props.cdpList.cdp.owner}>{props.cdpList.cdp.owner}</Link></td>
            <td className="submit-block"><TimeStamp time={props.cdpList.cdp.fees_updated}/></td>
                    ...
                    <Table striped className="cdp-list">
                        <thead>
                            ...
                            <th className="d-none d-sm-table-cell counter "><i className="material-icons">sort</i> <T>cdp.cdpID</T></th>
                                <th className="d-none d-sm-table-cell title"><i className="material-icons">account_circle</i> <span className="d-none d-sm-inline"><T>cdp.owner</T></span></th>
                                <th className="submit-block"><i className="material-icons">update</i> <span className="d-none d-sm-inline"><T>cdp.cdpFeesUpdated</T> (UTC)</span></th>
