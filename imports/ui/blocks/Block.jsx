                    ...
                    <Card>
                        ...
                        <CardBody>
                            <Row>
                                ...
                                <Col md={8} className="value"><Link to={"/validator/"+((proposer)?proposer.operator_address:'')}><Avatar moniker={moniker} profileUrl={profileUrl} address={(proposer)?proposer.operator_address:''} list={true} /> {moniker}</Link></Col>
