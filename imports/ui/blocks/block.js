...
export default class Block extends Component {
    ...
    render() {
        ...
        let moniker = (proposer&&proposer.description&&proposer.description.moniker)?proposer.description.moniker:proposer.address;
        ...
        return (
            <tr className="blockrow">
                ...
                <td className=""><Link to={"/validator/"+this.props.block.proposerAddress}><Avatar moniker={moniker} identity={identity} address={this.props.block.proposerAddress} list={true} /> {moniker}</Link></td>
