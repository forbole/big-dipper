    ...
    render() {
        ...
        if (proposer){
            ...
            return <Row className="block-info">
                ...
                {homePage ? <Col xs={4} sm={1} md={1}><i className="fas fa-sync d-sm-none"></i> {numbro(this.props.block.transNum).format('0,0')}</Col> : <Col xs={4} sm={1} md={2}><i className="fas fa-sync d-sm-none"></i> {numbro(this.props.block.transNum).format('0,0')}</Col>}
