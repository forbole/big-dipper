...
const ProposalRow = (props) => {
    return <tr>
        ...
        <td className="status"><ProposalStatusIcon status={props.proposal.status} /><span className="d-none d-sm-inline"> {voca.chain(props.proposal.proposal_status.substr(16)).replace('_', ' ').titleCase().value()}</span></td>
