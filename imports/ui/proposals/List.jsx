...
const ProposalRow = (props) => {
    ...
    <td className="deposit text-right">{props.proposal.value.total_deposit?numeral(props.proposal.value.total_deposit[0].amount).format('0,0'):'0'} <DenomSymbol denom={props.proposal.value.total_deposit?props.proposal.value.total_deposit[0].denom:'STAKE'} /></td>
</tr>
}
