    ...
    componentDidUpdate(prevProps){
        if (prevProps != this.props){
            this.setState({
                ...
                bondedRatio: this.props.states.bondedRatio
            })
                    ...
                    <Row className="status text-center">
                        ...
                        <Col lg={3} md={6}>
                            <Card body>
                                ...
                                <CardText><span className="display-4 value text-primary">{this.state.votingPower}</span><T percent={numbro(this.state.bondedRatio).format("0.00%")} totalStakes={numbro(this.state.totalSupply).format("0.0000a")} denom={Meteor.settings.public.stakingDenom}>chainStatus.fromTotalStakes</T></CardText>   
                            </Card>
                        </Col>
                    </Row>
                )
