...
export default class DepositHARD extends Component {
    constructor(props) {
        super(props)
    }
    ...
    render(){
        if (this.props){
            return <div><Button className="ledger-buttons-group my-2" color="primary" id="toggler_deposit_hard" size="sm"><T>transactions.info</T>  </Button>
                <UncontrolledCollapse toggler="#toggler_deposit_hard">
                    <Table responsive>
                        <tbody>
                            <tr>
