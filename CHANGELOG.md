...
* [#542] Updated average block time calculations to start calculations from the startHeight height set in settings.json instead of calculating it from genesis time.
